...
- [ACM TOMM](https://mc.manuscriptcentral.com/tomm): ACM Transactions on Multimedia Computing Communications and Applications (SCI三区, CCF B), [Link](https://dl.acm.org/journal/tomm)
