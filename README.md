...
投稿顺序：子刊 > SCI一区 Top > CCF A > SCI一区 > SCI二区Top > SCI二区 > CCF B



**Computer Vision and Artificial Intelligence**
- **IF > 10** :heart_eyes: :heart_eyes: :heart_eyes: 
...
- [TNNLS](https://mc.manuscriptcentral.com/tnnls): IEEE Transactions on Neural Networks and Learning Systems (SCI一区 Top, CCF B), [Link](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=5962385), IF<sub>24</sub>=10.2, 15页
...
- [TCDS](https://mc.manuscriptcentral.com/tcds-ieee): IEEE Transactions on Cognitive and Developmental Systems (SCI三区), [Link](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=7274989), IF<sub>25</sub>=4.9
...
- Computers & Graphics (SCI 四区), [Link](https://www.sciencedirect.com/journal/computers-and-graphics), IF<sub>24</sub>=2.5
...
- [WCL](https://mc.manuscriptcentral.com/wcl): IEEE Wireless Communications Letters (SCI三区), [Link](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=5962382), IF<sub>24</sub>=5.5
...
- [JRS](https://www.editorialmanager.com/remotesensing/default.aspx): Journal of Remote Sensing (SCI一区 Top, OA: 0$ before 2028.1.1), [Link](https://spj.science.org/journal/remotesensing), IF<sub>25</sub>=6.8
- [JSTARS](https://mc.manuscriptcentral.com/jstars): Journal of Selected Topics in Applied Earth Observations and Remote Sensing (SCI二区 Top, OA: ~~$1496~~ $1800), [Link](http://ieeexplore.ieee.org/xpl/tocresult.jsp?isnumber=4648334), IF<sub>24</sub>=4.7
...
- **Elsevier**
- Journal of Food Engineering (SCI二区 Top), [Link](https://www.journals.elsevier.com/food-quality-and-preference), IF<sub>24</sub>=5.3
...
- Journal of Dairy Science (SCI一区 Top, OA: 3500), [Link](https://www.sciencedirect.com/journal/journal-of-dairy-science), IF<sub>24</sub>=3.7
- ‌**Wiley**
...
**:clap::clap::clap:Congratulations! Your article has been published in the Early Access area on IEEE T-PAMI.**
